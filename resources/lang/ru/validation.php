...
return [
    ...
    */
    ...
    'after_or_equal'       => 'Атрибут: должен быть датой после даты или равной ей.',
    'alpha'                => 'Атрибут: должен содержать только буквы.',
    'alpha_dash'           => 'Атрибут: должен содержать только буквы, цифры, дефисы и подчеркивания.',
    ...
    'max'                  => [
        'numeric' => 'Атрибут: не должен быть больше, чем: макс.',
        'file'    => 'Атрибут: не должен быть больше: max килобайт.',
        'string'  => 'Атрибут: не должен содержать больше символов: max.',
    ...
    'required_if'          => 'Поле: attribute требуется, когда: other: значение.',
    ...
    'required_with_all'    => 'Поле: attribute является обязательным, если присутствуют: значения.',
    ...
    'prohibited_if'        => 'Поле: attribute запрещено, когда: other: значение.',
