...
$(document).ready(function () {
    ...
    $('.recent-work-details.active').parent().click();

    //Active header link while scrolling the mouse
    const sections = document.querySelectorAll('section');
    const navLi = document.querySelectorAll('nav .side-header  ul li');
