@extends('layouts.app')
@section('title')
{{__('messages.create_pricing_plan')}}
@endsection
@section('css')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4 custom-pricingplan">
                    <div class="col-lg-6 col-7 pri-text">
                        <h6 class="h2 text-white d-inline-block mb-0">{{__('messages.new_pricing_plan')}}</h6>
                    </div>
    ...
    <div class="container-fluid mt--6">
        <div class="card mb-4">
            <div class="card-body">
                ...
                {{ Form::open(['route' => 'pricing-plans.store','method'=>'post','id' =>'createPricingPlanForm', 'files' => true,]) }}
                @include('pricing_plan.fields')
                {{ Form::close() }}
            </div>
        </div>
