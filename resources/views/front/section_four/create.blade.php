@extends('layouts.app')
@section('title')
    {{__('messages.front_side_cms.create_section')}}
@endsection
@section('css')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4 custom-experience-edit">
                    <div class="col-lg-6 col-7 experience-text">
                        <h6 class="h2 text-white d-inline-block mb-0">{{__('messages.front_side_cms.create_section')}}</h6>
                    </div>
    ...
    <div class="container-fluid mt--6">
        <div class="card mb-4">
            <div class="card-body">
                ...
                {{ Form::open(['route' => 'section-four.store','method'=>'post','id' =>'createSectionFourForm', 'files' => true]) }}
                {{ Form::hidden('section',\App\Models\FrontCms::SECTION_FOUR, ['id' => 'sectionNo']) }}
                <div class="alert alert-danger d-none" id="validationErrorsBox"></div>
                @include('front.section_four.fields')
                {{ Form::close() }}
            </div>
        </div>
    </div>
...
@section('page_js')
    <script>
        let edit = false;
        let sectionFourDefaultColor = "#f5365c";
    </script>
