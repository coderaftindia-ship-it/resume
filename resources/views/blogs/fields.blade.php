<div class="row">
    <div class="form-group col-md-6">
        ...
        {{ Form::text('title', null , ['class' => 'form-control','placeholder' => __('messages.blog_placeholder.enter_title'),'required','id'=>'blogTitle']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('slug', __('messages.blogs_category.slug').':') }}<span class="text-danger">*</span>
        {{ Form::text('slug', null , ['class' => 'form-control','placeholder' => __('messages.blog_placeholder.enter_slug'),'required','id'=>'slugValue']) }}
    </div>
    <div class="form-group col-md-6">
        {{ Form::label('category_id', __('messages.blogs_category.category').':') }}<span class="text-danger">*</span>
        <div class="d-flex">
            {{ Form::select('category_id',$category,null, ['id'=>'category','class' => 'form-control','placeholder' => __('messages.blog_placeholder.select_category'),'required']) }}
    ...
    <div class="form-group blog-body col-md-12">
