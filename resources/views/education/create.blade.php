            ...
            <div class="header-body">
                <div class="row align-items-center py-4 custom-experience-edit">
                    <div class="col-lg-6 col-7 experience-text">
                        <h6 class="h2 text-white d-inline-block mb-0">{{__('messages.new_education')}}</h6>
                    </div>
                    <div class="col-lg-6 col-5 text-right exp-size">
                        <a href="{{route('educations.index')}}" class="btn btn-group-lg btn-neutral">{{__('messages.back')}}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
        <div class="card mb-4">
            <div class="card-body">
                ...
                {{ Form::open(['route' => 'educations.store','method'=>'post','id' =>'createEducationForm']) }}
