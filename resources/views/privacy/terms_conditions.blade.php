...
<ul>
    ...
    <li>
        <p><strong>Website</strong> refers to My Site, accessible from <a href="{{ route('front') }}"
                                                                          rel="external nofollow noopener"
                                                                          target="_blank">{{ route('front') }}</a></p>
    </li>
    <li>
...
<ul>
    <li>By visiting this page on our website: <a href="{{ route('front') }}"
                                                 rel="external nofollow noopener"
                                                 target="_blank">{{ route('front') }}</a>
    </li>
</ul>
