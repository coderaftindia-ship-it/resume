<script id="expirenceTemplate" type="text/x-jsrender">
...
<script id="currentlyWorkHereTemplate" type="text/x-jsrender">
      <label class="custom-toggle pl-0">
            <input type="checkbox" name="currently_work_here" class="isWorkHere" data-id="{{:id}}" {{:checked}}>
