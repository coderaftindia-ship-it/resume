<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="form-group">
            ...
            {{ Form::text('start_date',null, ['class' => 'form-control datepicker','required','placeholder'=> __('messages.select_start_date'),'data-date-end-date'=>"0d",'autocomplete'=>'off', 'id'=>'startDate', 'data-date-start-date'=>\Carbon\Carbon::parse(getUserDate())->format('m/d/Y')]) }}
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 d-none endDateDiv">
        <div class="form-group">
            ...
            {{ Form::text('end_date',null, ['class' => 'form-control datepicker end-date','placeholder'=> __('messages.select_end_date'),'data-date-end-date'=>"0d",'autocomplete'=>'off', 'id'=>'endDate' , 'data-date-start-date'=>\Carbon\Carbon::parse(getUserDate())->format('m/d/Y')]) }}
        </div>
    </div>
