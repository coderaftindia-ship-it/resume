@extends('layouts.app')
@section('title')
    {{__('messages.admin_users.user_details')}}
@endsection
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4 custom-title">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 custom-title-text">
                        <h6 class="h2 text-white d-inline-block mb-0">{{__('messages.admin_users.user_details')}}
                        </h6>
                    </div>
    ...
    <div class="container-fluid mt--6">
        <div class="card mb-4">
            <div class="card-body">
                @include('super_admin.users.show_field')
            </div>
        </div>
    </div>
@endsection
